...
public class TestAdlAuthorizer {
  ...
  public void testCreateClassInstanceSucceeds() throws Exception {
    ...
    assertTrue("Create method should have returned an instance", authorizer.isPresent());
  }

  @Test
  public void testCreateWithoutConfigurationReturnsEmpty() throws Exception {
    Optional<AdlAuthorizer> authorizer = AdlAuthorizerFactory.create(new Configuration());
    assertFalse("Create method should have returned an empty optional", authorizer.isPresent());
  }
